  ...
  <div id="unassigned">
    <div class="routerView flex1">
      <div id="scrollView" class="flex-d">
            ...
            <el-table class="overflowTable" ref="resultTable" @selection-change="handleSelectionChange" stripe border max-height="560" :data="list" v-loading="loading" tooltip-effect="dark" style="width: 100%;" highlight-current-row>
              ...
              <el-table-column :label="$t('common.operation')">
                <template slot-scope="scope">
                  <el-button v-if="button.distribution" size="mini" type="primary" @click="openDialog(false, scope.row)" plain>{{ $t('button.distribute') }}</el-button>
                </template>
              </el-table-column>
            </el-table>
        ...
        <!-- 分配对话框 -->
        <el-dialog class="dialogRec" :title="isRrcMult ? $t('button.batchAllocation') : $t('button.distribute')" :visible.sync="dialogVisible" @close="closeRecDia" :close-on-click-modal="false">
